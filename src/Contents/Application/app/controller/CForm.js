...
/* 		btnenregistrer_onclik: function( p, record ) // pour valider une demande avec son Px definitif
			{
					dat=record.data;
					UPDATE_ID=dat.ID_demande;
					console.log(dat.ID_demande);
			
				if (dat.ID_demande) // si ID_demande est vrai 
					{
						var rdgvalue=-1;
						var val_chbspecial=-1;
				...
				if (!dat.ID_demande) // si ID_demande est faux 
					{
						var o= {						
							service: App.get('combo#cbo2').getValue(),
							departement: App.get('combo#cbo1').getValue(),
